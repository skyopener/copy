...
:
    ...
    //dict_(dict),                                                                 // NEW !
    //densityFieldName_(dict_.lookupOrDefault<word>("densityFieldName","rho")),    // NEW !
    //rho_(mesh.lookupObject<volScalarField> (densityFieldName_))                  // NEW !
...
)
{
    ...
    volScalarField rho_ = mesh_.lookupObject<volScalarField>("rho");        // NEW !!
...
//const volScalarField& cfdemCloudIB::rhoField()  // const   // NEW !
//{
//    return rho_;
//}

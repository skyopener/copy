...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::cfdemCloudIB2::getDEMdata()
{
    Info << "Get DEM data test \n" << endl;
...
bool Foam::cfdemCloudIB2::reAllocArrays() const
{
    if(cfdemCloud::reAllocArrays())
    {
        Info <<"Foam::cfdemCloudIB2::reAllocArrays()"<<endl;
...
void Foam::cfdemCloudIB2::giveDEMdata()
{
...
inline double ** Foam::cfdemCloudIB2::DEMTorques() const
{
    return DEMTorques_;
}

bool Foam::cfdemCloudIB2::evolve
(
...
void Foam::cfdemCloudIB2::setInterFace
(
    volScalarField& interFace
)
{
...
void Foam::cfdemCloudIB2::calcVelocityCorrection
(
    volScalarField& p,
    volVectorField& U,
...
void Foam::cfdemCloudIB2::setParticleVelocity
(
    volVectorField& U
)
{
...
vector Foam::cfdemCloudIB2::angularVelocity(int index)
{
    vector vel;
...
double Foam::cfdemCloudIB2::getTortuosity(vector dir)
{
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
void cfdemCloudIB2::setRefinementField(volScalarField* refine_)
{
